 ...
 * @author karayel
 */
public abstract class SuggestionBug extends AbstractBug{

    public SuggestionBug() {
        super();
        initilaze();
        
    }
    
    public SuggestionBug(String source){
        super(source);
        initilaze();
    }
    /**
    ...
    private void initilaze(){
        setIcon(GeneralProperties.BUG_GREEN);
        setType(BugTypeEnum.SUGGESTION);
    }
}
